...
NUSCENES_LABELS_16 = ('barrier', 'bicycle', 'bus', 'car', 'construction vehicle', 'motorcycle', 'person', 'traffic cone',
                      ...
                      'box truck', 'oil tanker')

NUSCENES_LABELS_6 = ('background', 'car', 'person', 'bicycle', 'traffic cone', 'road')

NUSCENES6_COLORMAP = {
    0: (0, 255, 255), # background
    1: (0, 255, 0), # car
    2: (255, 255, 0), # person
    3: (0, 0, 255), # bycicle
...
PROPERTY_INFOS = ('where can sit', 'door', 'wall', 'floor')
PROPERTY_INFOS = ('background', 'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light', 'fire hydrant', 'stop sign', 
                  ...
                  'donut', 'cake', 'chair', 'couch', 'potted plant', 'bed', 'dining table', 'toilet', 'tv', 'laptop', 'mouse', 'remote', 'keyboard', 'cell phone', 'microwave', 
                  'oven', 'toaster', 'sink', 'refrigerator', 'book', 'clock', 'vase', 'scissors', 'teddy bear', 'hair drier', 'toothbrush', 'banner', 'blanket', 'bridge', 'cardboard', 
                  'counter', 'curtain', 'door-stuff', 'floor-wood', 'flower', 'fruit', 'gravel', 'house', 'light', 'mirror-stuff', 'net', 'pillow', 'platform', 'playingfield', 'railroad', 
                  'river', 'road', 'roof', 'sand', 'sea', 'shelf', 'snow', 'stairs', 'tent', 'towel', 'wall-brick', 'wall-stone', 'wall-tile', 'wall-wood', 'water', 'window-blind', 'window', 
                  'tree', 'fence', 'ceiling', 'sky', 'cabinet', 'table', 'floor', 'pavement', 'mountain', 'grass', 'dirt', 'paper', 'food', 'building', 'rock', 'wall', 'rug')

PROPERTY_INFOS_COLOR_MAP = {
    1: (214., 39., 40.), # door
    2: (152., 223., 138.), # floor
...
NUSCENES16_COLORMAP = {
    ...
    17: (255,0, 0), # box truck
    18: (0,255, 0), # oil tanker
    19: (0, 0, 0), # unknown
    }
