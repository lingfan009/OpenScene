...
def main():
    autra_train_package_data_root = "xxx/20223NN"
    openscene_train_data = "data/"
    dataset_type = "train"
    for batch_path in os.listdir(autra_train_package_data_root.split(";")):
        for record_name in os.listdir(batch_path):
            record_path = osp.join
