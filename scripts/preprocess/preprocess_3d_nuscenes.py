...
in_path = "/home/fan.ling/Work/big_model/openScene/openscene/original_dataset/samples/LIDAR_TOP"
...
#     files.append(os.path.join(in_path, file))
#
# p = mp.Pool(processes=mp.cpu_count())
# p.map(process_one_sequence, files)
# p.close()
